    ...
    <section>
      ...
      <ul className="list-disc space-y-4">
        <li className="font-serif">
          <p className="transition-all font-semibold">{`“PSPACE-hardness of Two-Player Games”`}</p>, with Tanvi Deshpande, 2024, Stanford University, available 
            <a className="transition-all relative after:bg-white after:absolute after:h-1 after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 cursor-pointer"
